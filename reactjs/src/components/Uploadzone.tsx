...
import type { UploadZoneProp } from "../types"
import { UploadIcon, XIcon } from "lucide-react"

export const Uploadzone = ({ label, file, onClear, onChange }: UploadZoneProp) => {
    return (
                ...
                {file ? (
                    <>
                        ...
                        rounded-xl backdrop-blur-sm">
                            ...
                            hover:text-red-400 tranistion-colors">
                   ...
                   <>
    <div
        className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300"
    >
